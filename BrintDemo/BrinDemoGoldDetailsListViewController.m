...
- (void)viewDidLoad {
  ...
  self.sectionsArray = [[NSMutableArray alloc] initWithObjects:@"Gold design type1", @"Gold design type2", @"Gold design type3", @"Gold design type5", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  cell.goldItemLable.text = [self.sectionsArray objectAtIndex:indexPath.row];
  return cell;
}
